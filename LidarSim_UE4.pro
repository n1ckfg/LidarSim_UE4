...
unrealRootPath=/home/nick/GitHub/WISE/anm_unreal_sim/submodules/UnrealEngine
LidarSim_UE4RootPath=/home/nick/GitHub/UNREAL_PLUGINS/LidarSim_UE4

gameProjectFile=/home/nick/GitHub/UNREAL_PLUGINS/LidarSim_UE4/LidarSim_UE4.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(LidarSim_UE4Source.pri)
include(LidarSim_UE4Header.pri)
include(LidarSim_UE4Config.pri)
include(LidarSim_UE4Includes.pri)
include(LidarSim_UE4Defines.pri)
...
LidarSim_UE4-Linux-Debug.commands = $$build LidarSim_UE4 Linux Debug  -project="\"$$gameProjectFile\"" $$args
LidarSim_UE4-Linux-DebugGame.commands = $$build LidarSim_UE4 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
LidarSim_UE4-Linux-Shipping.commands = $$build LidarSim_UE4 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
LidarSim_UE4-Linux-Test.commands = $$build LidarSim_UE4 Linux Test  -project="\"$$gameProjectFile\"" $$args
LidarSim_UE4.commands = $$build LidarSim_UE4 Linux Development  -project="\"$$gameProjectFile\"" $$args

LidarSim_UE4Editor-Linux-Debug.commands = $$build LidarSim_UE4Editor Linux Debug  -project="\"$$gameProjectFile\"" $$args
LidarSim_UE4Editor-Linux-DebugGame.commands = $$build LidarSim_UE4Editor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
LidarSim_UE4Editor-Linux-Shipping.commands = $$build LidarSim_UE4Editor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
LidarSim_UE4Editor-Linux-Test.commands = $$build LidarSim_UE4Editor Linux Test  -project="\"$$gameProjectFile\"" $$args
LidarSim_UE4Editor.commands = $$build LidarSim_UE4Editor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	LidarSim_UE4-Linux-Debug \
	LidarSim_UE4-Linux-DebugGame \
	LidarSim_UE4-Linux-Shipping \
	LidarSim_UE4-Linux-Test \
	LidarSim_UE4 \
	LidarSim_UE4Editor-Linux-Debug \
	LidarSim_UE4Editor-Linux-DebugGame \
	LidarSim_UE4Editor-Linux-Shipping \
	LidarSim_UE4Editor-Linux-Test \
	LidarSim_UE4Editor \
