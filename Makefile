...
LidarSim_UE4-Linux-Debug:
	 $(PROJECTBUILD) LidarSim_UE4 Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

LidarSim_UE4-Linux-DebugGame:
	 $(PROJECTBUILD) LidarSim_UE4 Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

LidarSim_UE4-Linux-Shipping:
	 $(PROJECTBUILD) LidarSim_UE4 Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

LidarSim_UE4-Linux-Test:
	 $(PROJECTBUILD) LidarSim_UE4 Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

LidarSim_UE4:
	 $(PROJECTBUILD) LidarSim_UE4 Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

LidarSim_UE4Editor-Linux-Debug:
	 $(PROJECTBUILD) LidarSim_UE4Editor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

LidarSim_UE4Editor-Linux-DebugGame:
	 $(PROJECTBUILD) LidarSim_UE4Editor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

LidarSim_UE4Editor-Linux-Shipping:
	 $(PROJECTBUILD) LidarSim_UE4Editor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

LidarSim_UE4Editor-Linux-Test:
	 $(PROJECTBUILD) LidarSim_UE4Editor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

LidarSim_UE4Editor:
	 $(PROJECTBUILD) LidarSim_UE4Editor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
